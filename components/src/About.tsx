      ...
      <div className="space-y-6">
        <div className="mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-xl leading-relaxed text-left text-sm pb-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#projects"
                className="px-8 py-3 border border-purple-600 text-purple-400 rounded-lg hover:bg-purple-600/10 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30"
              >
                View Projects
              </a>
            </div>
